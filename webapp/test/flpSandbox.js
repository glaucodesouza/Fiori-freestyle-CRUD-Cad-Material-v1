					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cadastro de Materiais V1",
									"targetURL": "#cadmatv1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cadmatv1-display": {
								"semanticObject": "cadmatv1",
								"action": "display",
								"description": "Cadastro de Materiais V1",
								"title": "Cadastro de Materiais V1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cadmatv1",
									"url": sap.ui.require.toUrl("cadmatv1")
								}
							}
						}
					}
